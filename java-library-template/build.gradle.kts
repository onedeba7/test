...
object Meta {
    ...
    const val githubRepo = "onedeba7/test"
    const val developerId = "onedeba7"
    const val developerName = "Debashis Sabar"
    const val developerOrganization = "io.github"
    const val developerOrganizationUrl = "https://github.com"
}
